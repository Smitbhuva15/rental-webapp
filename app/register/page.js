...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        // Automatically redirects to dashboard or admin based on logic 
        // (default is User role, so dashboard mostly)
      ...
      <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl shadow-xl overflow-hidden border border-slate-200 dark:border-slate-800">
        <div className="px-8 pt-10 pb-8">
          <div className="mb-8 text-center">
            ...
            <p className="text-slate-500 mt-2">Join RentHub directly, without the broker.</p>
          </div>
